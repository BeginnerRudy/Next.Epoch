                ...
                for paper in papers:
                    try:
                        ...
                        content_model = ContentItemModel(
                            ...
                            score_breakdown=scored_content.score_breakdown.model_dump() if scored_content.score_breakdown else None,
                            signals=[s.model_dump() for s in scored_content.signals],
                            provenance=scored_content.provenance.model_dump() if scored_content.provenance else None,
